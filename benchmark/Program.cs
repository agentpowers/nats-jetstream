...
namespace Benchmark
{
    class Benchmark
    {
        ...
        void runSuite()
        {
            runPub("PubOnlyNo", count, 0);
            runPub("PubOnly8b", count, 8);
            runPub("PubOnly32b", count, 32);
            runPub("PubOnly256b", count, 256);
            runPub("PubOnly512b", count, 512);
            runPub("PubOnly1k", count, 1024);
            runPub("PubOnly4k", 500000, 1024 * 4);
            runPub("PubOnly8k", 100000, 1024 * 8);

            runPubSub("PubSubNo", count, 0);
            runPubSub("PubSub8b", count, 8);
            runPubSub("PubSub32b", count, 32);
            runPubSub("PubSub256b", count, 256);
